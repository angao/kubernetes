...
type ExtendedResourceClaim struct {
	...
	Spec ExtendedResourceClaimSpec
...
type ExtendedResourceClaimSpec struct {
	...
	// ExtendedResourceNames are the names of ExtendedResource
	// +optional
...
type ExtendedResourceClaimStatus struct {
	...
	// +optional
	Phase ExtendedResourceClaimPhase
...
type ExtendedResourceSpec struct {
	...
	// +optional
	NodeAffinity *ResourceNodeAffinity
