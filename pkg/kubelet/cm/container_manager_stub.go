...
func (cm *containerManagerStub) GetDevicePluginResourceCapacity() ([]string, []string, []string) {
...
func (cm *containerManagerStub) UpdatePluginResources(*lifecycle.PodAdmitAttributes) error {
	return nil
}
